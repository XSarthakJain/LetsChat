...
urlpatterns = [
    ...
    path("showProfilePicfun/",views.showProfilePicfun,name="showProfilePicfun"), #showPhotosfun   
    path("showCoverPicfun/",views.showCoverPicfun,name="showCoverPicfun"), #showCoverPicfun   
    path("showPostPicfun/",views.showPostPicfun,name="showPostPicfun"), #showCoverPicfun   
    path("showOtherPicfun/",views.showOtherPicfun,name="showOtherPicfun"), #showOtherPicfun
    path("showSelectOptionPic/",views.showSelectOptionPic,name="showSelectOptionPic"), #showSelectOptionPic
    path("groupCreationForm/",views.groupCreationForm,name="groupCreationForm"), #Group Creation
    path("leaveGroup/",views.leaveGroup,name="leaveGroup"), #Group leave Group
    path("groupUpdationForm/",views.groupUpdationForm,name="groupUpdationForm"), #Group Updation
    path("storyreply/",views.storyreply,name="storyreply"),
    path("About/",views.aboutUs,name="About"),#Show About page
    path("Contact/",views.contactUs,name="Contact"),#Show Contact Us Page
    path("ContactSubmission/",views.ContactSubmission,name="ContactSubmission"),#ContactSubmission
    path("spamMessageTester/",views.spamMessageTester,name="spamMessageTester"),#spamMessageTester
